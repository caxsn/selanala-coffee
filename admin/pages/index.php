                                ...
                                <div class="panel-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover display" id="">
                                        ...
                                        <tbody>
                                            <?php
                                        require('../config/db.php');
                                        $sqltrx = mysqli_query($conn,"SELECT no, idTransaksi, c.idUser, namaUser, daftarBarang, jumlah, tanggal, total, status FROM tabel_user c JOIN tabel_transaksi s USING (idUser) ");
                                        $num = 1;
                                        ...
                                        echo '<tr class="odd gradeX">
                                            ...
                                            <td>Rp. '.$data[total].'</td>
                                            <td>'.$data[status].'</td>
                                            <td><a href="#Transaksi" class="btn btn-success btn-xs" id="idTrx" data-toggle="modal" data-id="'.$data['no'].'">Proses</a></td>
                                        </tr>
                                        ';
                                        $num++;
                                        }
                                                    ...
                                                    <div class="col-lg-12">
                                                        <form action="tambahUser.php" method="post" role="form" enctype="multipart/form-data" id="formuser">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" name="namaUser" placeholder="Masukkan Nama User" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Email</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Alamat</label>
                                                                <textarea class="form-control" name="alamat" rows="5" placeholder="Jalan Mencari Surga" style="resize:none" required></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Telp</label>
                                                                <input class="form-control" name="telp" placeholder="021999399" required="">
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                ...
                                <div class="panel-body">
                                    <table width="100%" class="table table-striped table-bordered table-hover display" id="">
                                        ...
                                        echo '<tr class="odd gradeX">
                                            ...
                                            <td>'.$data[alamat].'</td>
                                            <td>'.$data[telp].'</td>
                                            <td><a href="#UpdateUser" class="btn btn-primary btn-xs" id="idUser" data-toggle="modal" data-id="'.$data['idUser'].'">Edit</a> <a href="javascript:;"  data-id="'.$data['idUser'].'" data-toggle="modal" data-target="#modal-konfirmasi2" class="btn btn-danger btn-xs">Hapus</a></td>
                                        </tr>
                                        ';
                                        $num++;
                                        }
