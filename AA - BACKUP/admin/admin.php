...
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-2" id="sideLeft">
      <h4><strong>Halaman Administrator</strong></h4>
    ...
    <div class="col-xs-10">
      <div class="tab-content">
        ...
        <div id="barang" class="tab-pane fade">
          ...
          <button type="button" class="btn btn-success" id="tambah-data-barang" data-toggle="modal" data-target="#form-barang">Tambah Barang</button>
          ...
          <div class="container">
            ...
            <ul class="nav nav-pills" style="margin-left: 15vw;">             
              <li class="item-kategori"><a data-toggle="tab" href="#tabel-robusta">Robusta</a></li>
            </ul>
          </div>

            <div class="tab-content">
              <div id="tabel-robusta" class="tab-pane fade">
                <div class="row">
                  <div class="col-xs-11 col-offset-xs-1">
                    <table class="table table-condensed" style="width:80vw">
                      <thead>
                        <tr>
                          ...
                          <th class="ukuran-barang text-center">Level Roasting</th>
