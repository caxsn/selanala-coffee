   ...
   <body>
            ...
            <div class="col-xs-8 col-xs-offset-2">
               <div class="table-responsive">
                  <table class="table">
                     <thead>
                        <tr>
                           <h3 style="font-family: Roboto;"><strong>Keranjang Belanja</strong></h3>
                        </tr>
                     </thead>
                     <tbody>
                        <?php 
                           ...
                           while($arrayTrolly = mysqli_fetch_array($query_trolly)){
                             ...
                             echo '
                               <tr>
                                 <td><img src="image/produk/'.$arrayProduk['path'].'"></td>
                                 <td>
                                   <h4><strong>'.$arrayProduk['nama'].'</strong></h4>
                                   <h5><strong>Harga</strong><span class="titik-harga">:</span> Rp.'.$arrayProduk['harga'].'</h5>
                                   <form action="proses/updateTrolly.php" method="GET" id="keranjang" >
                                   <input type="hidden" name="idTrolly" value="'.$arrayTrolly['idTrolly'].'">
                                   <input type="hidden" name="harga" value="'.$arrayProduk['harga'].'">
                                   <div class="form-group">
                                        <label>Jumlah<span class="titik-harga">:</span></label>
                                        <input type="number" value="'.$arrayTrolly['jumlah'].'" name="jumlah" min="1" max="'.$arrayProduk['stock'].'">
                                    </div>
      ...
      <?php
         if($belumAda==0){
           ...
           <a href="proses/bayar.php?idUser='.$_SESSION['idUser'].'&&total='.$arrayTotal[0].'"><button type="submit" name="submit" tp class="btn btn-success"><strong>Beli Sekarang</strong></button></a>
           <a href="index.php"><button type="button" class="btn btn-success" style="margin-left:38vw"><strong>Kembali Berbelanja</strong></button></a>
         </div>
         ';
         }
